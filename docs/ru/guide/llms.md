...
[Claude Code скилл](https://github.com/Olovyannikov/effector-refetch/tree/main/skills) обучает
...
Либо скопируйте [`skills/effector-refetch/SKILL.md`](https://github.com/Olovyannikov/effector-refetch/blob/main/skills/effector-refetch/SKILL.md)
...
- **[`/llms.txt`](https://olovyannikov.github.io/effector-refetch/llms.txt)** — индекс: заголовок,
  описание и ссылки на все страницы документации.
- **[`/llms-full.txt`](https://olovyannikov.github.io/effector-refetch/llms-full.txt)** — полный
